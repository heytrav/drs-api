...
router.register(r'contact-handles', views.ContactViewSet, "contacthandle")
...
router.register(r'registrant-handles', views.RegistrantViewSet, "registranthandle")
...
router.register(r'domain-handle', views.DomainContactViewSet, "domainhandles")
